      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <button
            ...
            className="sm:hidden text-gray-300 hover:text-emerald-400 transition duration-300"
          >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:block text-gray-300 hover:text-emerald-400 cursor-pointer transition duration-300">
            Source
          </div>
        </div>
      </div>
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 h-screen w-3/4 sm:hidden bg-black/95 border-r border-emerald-800 z-50 backdrop-blur-md flex flex-col"
          >
            ...
            <div className="mt-auto px-6 pb-6 border-t border-emerald-800 flex items-center justify-between text-gray-300 ">
              <Link
                to="/github"
                className="flex items-center gap-2 hover:text-emerald-400  mt-3"
                onClick={() => setMenuOpen(false)}
              >
                <Github size={20} /> <span>98.7K</span>
              </Link>
              <div className="hover:text-emerald-400 cursor-pointer mt-3">
                Source
              </div>
            </div>
          </motion.div>
